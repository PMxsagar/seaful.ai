...
export const mockPitchSuggestions: PitchSuggestion[] = [
  {
    ...
    prospectId: '1',
    productId: '1',
    content: 'Hi John, I understand your team is looking to enhance their ML capabilities. Our ML Mastery program has helped 200+ engineering teams like yours build production-ready ML systems in just 6 months.',
  ...
  },
  {
    ...
    prospectId: '1',
    productId: '1',
    content: 'I hear your concern about the budget. Let me share how TechCorp similar to yours achieved 300% ROI within 12 months by investing in ML training. We also offer flexible payment options.',
  ...
  notifications: [
    {
      ...
      type: 'success',
      title: 'Deal Closed!',
      message: 'Sarah Johnson from EduTech Innovations just signed up for Leadership Excellence Program',
